      ...
      <div className="max-w-[925px]">
        <div className="text-[13px] md:text-sm text-[#545454] font-normal mb-10 sm:mb-10 md:mb-0">
          ...
          <p>
            ...
            https://losangelesgeneralcontractor.com/wordpress. This privacy
            notice applies solely to information collected by this website,
        ...
        <div className="md:pt-[90px] mb-10 sm:mb-10 md:mb-0">
          ...
          <p className="text-[13px] md:text-sm text-[#545454] font-normal">
            ...
            users to enhance their experience on our site. Usage of a cookie is

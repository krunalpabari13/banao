  ...
  return (
    <section>
      <div className="px-5 md:px-8 lg:px-[7.5rem] my-5 md:my-8 lg:my-[4.75rem]">
        <h1 className="font-normal text-3xl md:text-4xl lg:text-[3.125rem] mb:3 md:mb-5 lg:mb-9">Turnkey Solution For Every Project</h1>
      ...
      <div className="flex h-[20rem] md:h-[25rem] lg:h-[30.938rem]">
        <img  width="100%" src={SliderImg1} alt="Hero image 1" />
